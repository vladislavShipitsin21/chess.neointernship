...
import neointernship.bots.straregy.StrategyExpectiMax;
...
public class ExpectiMaxBot extends APlayer{
    private BoardView boardView;
    private IPossibleActionList possibleActionList;
    private final IInput input;

    private Strategy strategyExpectimax;

    public ExpectiMaxBot(final Color color) {
        super(color, "expectiMax-bot");
    ...
    public void init(final IMediator mediator, final IBoard board, final Color color) {
        ...
        strategyExpectimax = new StrategyExpectiMax(color);
    }
    ...
    public String getAnswer() {
        ...
        final IAnswer answer = strategyExpectimax.getAnswer(startPosition);
