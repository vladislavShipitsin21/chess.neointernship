...
public class Server implements IServer {
    ...
    private void createNewLobby() throws Exception {
        if (!(whiteSideWaitingConnectionList.isEmpty() || blackSideWaitingConnectionList.isEmpty())) {
            ...
            final Lobby lobby = new Lobby(this, whiteSideConnection, blackSideConnection, lobbyNum++, ChessType.CLASSIC);
            lobbyList.add(lobby);
            lobby.start();
        }
    }
